(function (ns) {
    ...
    MusicSystem.prototype.stopEffect = function (effect, forced) {
        if(forced === undefined){forced=false;}
        if (this.currentEffects[effect] !== undefined) {
            this.currentEffects[effect].stop(forced);
    ...
    MusicSystem.prototype.stopAllEffects = function () {
        ...
        for (var i = 0, length = effects.length; i < length; ++i) {
            ...
            this.stopEffect(effectName, true);
        }
        this.currentEffects = {};
    }
        ...
        var musicLoop = {
            ...
            stop: function (forced) {
                ...
                if (this.currentSound !== undefined) {
                    if (!(data.stopSound === undefined || forced)) {
